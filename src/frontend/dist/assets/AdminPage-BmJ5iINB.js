import { c as createLucideIcon, R as React2, p as useComposedRefs, j as jsxRuntimeExports, k as createSlot, r as reactExports, i as cn, B as Button, X, u as ue } from "./index-BCMvTrdF.js";
import { B as Badge } from "./badge-Mcw9Tx6m.js";
import { d as createContextScope, u as useId, e as composeEventHandlers, f as useControllableState, g as useCallbackRef, P as Presence, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog-B-gLjX6w.js";
import { L as Label, I as Input } from "./label-D7lUWdOA.js";
import { P as Primitive } from "./index-JZwGUCbb.js";
import { e as getAllRecharges, f as getAllWithdrawals, h as getAllLocalUsers, i as approveRechargeLocal, r as rejectRechargeLocal, j as approveWithdrawalLocal, k as rejectWithdrawalLocal, u as updateUserBalance, l as deleteUser } from "./adminStore-DR4uEK1x.js";
import { A as ArrowLeft } from "./arrow-left-DGXBSDC8.js";
import { T as TrendingUp } from "./trending-up-De5fq8eJ.js";
import { C as Check } from "./check-BcL5KQK1.js";
/**
...
function AdminPage({ onBack }) {
  const [recharges, setRecharges] = reactExports.useState(
  ...
  const [users, setUsers] = reactExports.useState(() => getAllLocalUsers());
  ...
  const [editBalance, setEditBalance] = reactExports.useState("");
  const reload = () => {
    setRecharges(
      [...getAllRecharges()].sort((a, b) => b.timestamp - a.timestamp)
    );
  ...
  const filteredRecharges = recharges.filter(
    (r) => rechargeFilter === "all" ? true : r.status === rechargeFilter
  );
  const filteredWithdrawals = withdrawals.filter(
    (w) => withdrawalFilter === "all" ? true : w.status === withdrawalFilter
  );
  const totalApproved = recharges.filter((r) => r.status === "completed").reduce((s, r) => s + r.amount, 0);
  const totalPaidOut = withdrawals.filter((w) => w.status === "approved").reduce((s, w) => s + w.amount, 0);
  const handleApproveRecharge = (id) => {
    approveRechargeLocal(id);
    ue.success("Recharge approved!");
    reload();
  };
  const handleRejectRecharge = (id) => {
  ...
  const handleSaveBalance = () => {
    ...
    if (Number.isNaN(val) || val < 0) {
      ue.error("Enter a valid balance");
      return;
    }
    updateUserBalance(editUser.phone, val);
    ue.success("Balance updated!");
    setEditUser(null);
    reload();
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "recharges", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "grid grid-cols-3 w-full mb-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "recharges", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl p-3 card-shadow text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-bold text-primary", children: recharges.length }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mb-3 flex-wrap", children: ["all", "pending", "completed", "failed"].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
        ...
        filteredRecharges.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: formatTime(r.timestamp) })
                ] })
              ] }),
              r.status === "pending" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 shrink-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "withdrawals", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl p-3 card-shadow text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-bold text-primary", children: withdrawals.length }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "Total" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl p-3 card-shadow text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mb-3 flex-wrap", children: ["all", "pending", "approved", "rejected"].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
        ...
        filteredWithdrawals.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: "text-center text-muted-foreground py-8",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: formatTime(w.timestamp) })
                ] })
              ] }),
              w.status === "pending" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 shrink-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    size: "sm",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "users", children: users.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          className: "text-center text-muted-foreground py-8",
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm", children: user.phone }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Dialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-[340px] rounded-2xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Edit Balance" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
              "User: ",
              editUser == null ? void 0 : editUser.phone
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "New Balance (₹)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  type: "number",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { className: "w-4 h-4 mr-1" }),
                    " Save"
                  ]
                }
              )
