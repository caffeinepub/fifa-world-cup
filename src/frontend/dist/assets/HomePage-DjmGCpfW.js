import { a as useInternetIdentity, b as useUserProfile, d as useAllPlans, e as useUserInvestments, r as reactExports, f as useCreateInvestment, j as jsxRuntimeExports, u as ue, B as Button } from "./index-F6SCI0qL.js";
import { B as Badge, L as LoaderCircle } from "./index-CbJp7eRf.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog-DS9BaXqj.js";
import { S as Skeleton } from "./skeleton-CamRzI1R.js";
import { C as ChevronRight } from "./chevron-right-BNPsYEMv.js";
...
function BannerSlider() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        slide.type === "image" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-bold text-xl", children: slide.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-sm mt-1", children: slide.tagline })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl", children: slide.emoji })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: BANNER_SLIDES.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => setActive(i),
                className: `h-1.5 rounded-full transition-all duration-300 ${i === active ? "w-6 bg-yellow-400" : "w-2 bg-white/40"}`
              },
              s.type === "image" ? "dot-image" : s.name
            ))
          }
        )
      ]
...
function HomePage({ onNavigate }) {
  ...
  const handlePurchaseClick = (plan) => {
    const balance = (profile == null ? void 0 : profile.walletBalance) ?? 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-bold text-xl mb-4", children: (profile == null ? void 0 : profile.username) ?? "Investor" }),
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white font-bold text-base", children: [
                    "₹",
                    ((profile == null ? void 0 : profile.walletBalance) ?? 0).toFixed(0)
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white font-bold text-base", children: [
                    "₹",
                    ((profile == null ? void 0 : profile.totalEarned) ?? 0).toFixed(0)
                  ] })
                ]
              }
            )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BannerSlider, {}) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-4 mt-4", children: [
      ...
      plansLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [1, 2, 3].map((_i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-44 w-full rounded-2xl" }, _i)) }) : activePlans.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No plans available" })
        }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground leading-relaxed", children: [
                      ...
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold", style: { color: "#b8860b" }, children: [
                        "₹",
                        ((profile == null ? void 0 : profile.walletBalance) ?? 0).toFixed(0)
                      ] }),
                      ". You need",
              ...
              currentPlan && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary rounded-xl p-4 space-y-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-y-1 text-sm", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold", style: { color: "#b8860b" }, children: [
                      "₹",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "text-center py-6 text-xs text-muted-foreground", children: [
      "© ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-4 gap-2 mb-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center border-x border-border", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-bold text-sm", style: { color: "#b8860b" }, children: [
                "₹",
                dailyRupees.toFixed(0)
              ] })
            ] }),
