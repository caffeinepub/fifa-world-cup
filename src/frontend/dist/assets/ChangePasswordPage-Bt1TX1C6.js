import { r as reactExports, j as jsxRuntimeExports, u as ue } from "./index-DYsE67EW.js";
import { A as ArrowLeft } from "./arrow-left-Dfqqdgwq.js";
import { E as EyeOff, a as Eye } from "./eye-CTEzJDJO.js";
function ChangePasswordPage({
  ...
  const handleConfirm = async () => {
    ...
    if (storedHash !== enteredHash && storedHash !== oldPwd) {
      ue.error("Old password is incorrect");
      return;
    }
    setIsPending(true);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-100 min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-blue-700 flex items-center gap-3 px-4 py-3 text-white", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-base", children: "Change Password" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-blue-900 to-blue-700 px-5 py-8 flex flex-col items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-white/20 flex items-center justify-center text-3xl", children: "🔒" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-base", children: "Update Login Password" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-xs", children: "Keep your account secure" })
    ] }),
